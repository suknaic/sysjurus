            ...
            <div className="card-premium">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div>
                        ...
                        {errors.customer_id && <p className="mt-1.5 text-sm text-red-500 font-medium">{errors.customer_id}</p>}
                    </div>
                    <div>
                        ...
                        {errors.amount && <p className="mt-1.5 text-sm text-red-500 font-medium">{errors.amount}</p>}
                    </div>
                    <div>
                        <label className="block text-sm font-semibold text-gray-700 mb-1.5">Total de Parcelas *</label>
                    ...
                    <div>
                        <label className="block text-sm font-semibold text-gray-700 mb-1.5">Frequencia *</label>
                    ...
                    <div>
                        <label className="block text-sm font-semibold text-gray-700 mb-1.5">1º Pagamento *</label>
                    ...
                    <div>
                        <label className="block text-sm font-semibold text-gray-700 mb-1.5">Juros (%)</label>
                    ...
                    <div>
                        <label className="block text-sm font-semibold text-gray-700 mb-1.5">Multa (R$)</label>
                    ...
                    <div className="md:col-span-2 lg:col-span-3">
                        <label className="block text-sm font-semibold text-gray-700 mb-1.5">Observacao</label>
