            ...
            <div className="card-premium">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div className="flex items-end gap-2">
                        <input type="checkbox" checked={data.phone_is_international} onChange={(e) => setData('phone_is_international', e.target.checked)} className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" id="intl" />
                        <label htmlFor="intl" className="text-sm text-gray-700 pb-1">Internacional</label>
                    </div>
                    <div>
            ...
            <div className="card-premium">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div className="lg:col-span-2">
                        <label className="block text-sm font-semibold text-gray-700 mb-1.5">Endereco</label>
